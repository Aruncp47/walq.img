...
class Sugarpg extends StatefulWidget {
  const Sugarpg({super.key});

  @override
  State<Sugarpg> createState() => _SugarpgState();
}

class _SugarpgState extends State<Sugarpg> {
  List<String> folders = [];
  ...
  Future<void> fetchFolders() async {
    try {
      ...
      final ListResult result =
          await FirebaseStorage.instance.ref('sugarimages').listAll();
