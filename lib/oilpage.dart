...
class Oilimgpg extends StatefulWidget {
  const Oilimgpg({super.key});

  @override
  State<Oilimgpg> createState() => _OilimgpgState();
}

class _OilimgpgState extends State<Oilimgpg> {
  ...
  Future<void> fetchImages() async {
    try {
      ...
      final ListResult result =
          await FirebaseStorage.instance.ref('oilimages').listAll();
