...
class Ricepg extends StatefulWidget {
  const Ricepg({super.key});

  @override
  State<Ricepg> createState() => _RicepgState();
}

class _RicepgState extends State<Ricepg> {
  List<String> folders = [];
  ...
  Future<void> fetchFolders() async {
    try {
      ...
      final ListResult result =
          await FirebaseStorage.instance.ref('riceimages').listAll();
