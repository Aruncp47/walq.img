...
class Prospecpg extends StatefulWidget {
  const Prospecpg({super.key});

  @override
  State<Prospecpg> createState() => _ProspecpgState();
}

class _ProspecpgState extends State<Prospecpg> {
  List<String> folders = [];
  ...
  Future<void> fetchFolders() async {
    try {
      ...
      final ListResult result =
          await FirebaseStorage.instance.ref('productsspecimages').listAll();
  ...
  Future<void> fetchImagesFromFolder(String folderName) async {
    ...
    try {
      final ListResult result = await FirebaseStorage.instance
          .ref('productsspecimages/$folderName')
          .listAll();
