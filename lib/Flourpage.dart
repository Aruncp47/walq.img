...
class Flourpg extends StatefulWidget {
  const Flourpg({super.key});

  @override
  State<Flourpg> createState() => _FlourpgState();
}

class _FlourpgState extends State<Flourpg> {
  List<String> folders = [];
  ...
  Future<void> fetchFolders() async {
    try {
      ...
      final ListResult result =
          await FirebaseStorage.instance.ref('flourimages').listAll();
