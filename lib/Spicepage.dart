...
class Spicepg extends StatefulWidget {
  const Spicepg({super.key});

  @override
  State<Spicepg> createState() => _SpicepgState();
}

class _SpicepgState extends State<Spicepg> {
  ...
  Future<void> fetchImages() async {
    try {
      ...
      final ListResult result =
          await FirebaseStorage.instance.ref('wholespicesimages').listAll();
